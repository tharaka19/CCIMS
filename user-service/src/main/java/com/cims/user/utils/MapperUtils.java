...
public class MapperUtils {
    ...
    /**
     * This method maps an entity to a DTO for the client to consume.
     *
     * @param entity   the entity to be mapped
     * @param dtoClass the class of the DTO to map to
     * @return a new instance of the specified DTO class, mapped from the entity
     */
    public <T, U> U mapEntityToDTOForClient(T entity, Class<U> dtoClass) {
